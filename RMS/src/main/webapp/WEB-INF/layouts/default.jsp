...
<link href="<c:url value ='/static/plugins/toastr/toastr.min.css' />"
	rel="stylesheet" type="text/css" />
<link href="<c:url value ='/static/css/app.css" rel="stylesheet' />" />

<link
	href="<c:url value ='/static/css/jquery-ui.css" rel="stylesheet' />" />
</head>
<body>
	...
	<script src="<c:url value = '/static/js/common/js_constant.js'/>"></script>
	<script src="<c:url value = '/static/js/common/main.js'/>"></script>
	<script src="<c:url value = '/static/js/common/girdCustom.js'/>"></script>
